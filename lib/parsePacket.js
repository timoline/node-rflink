 ...
 * Parse RFLink packet
 *
 * @param packet : RFLink packet according to the RFLink specification
 */
function parsePacket(packet) {
	...
	//rebuild the special control commands
	rebuildSpecialControlCommands(parsedPacket.name_id);
...
/**
 * rebuildSpecialControlCommands
 *
 * @param name : 
 */
function rebuildSpecialControlCommands(name) {
	
	if(name.includes("pong")) {
		console.log(name);
		return;
	}

	if(name.includes("nodo")) {
		console.log(name);
		return;
	}	
